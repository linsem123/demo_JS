...
export default {
    ...
    // 首页初始化
    initHome(data){
        let url = GLOBAL.URL+"/main/api/borrowing/mainSearchAndChange.json";
        let params = data;
    ...
    // 试算
    changeMoney(data){
        let url = GLOBAL.URL+"/main/api/borrowing/feeTrial.json";
        let params = data;
        if(data.channel=="hxdapp"){
            return hxdRESTPluginPost(url,params);
        }
    ...
    // 首页申请提交
    submitInfo(data){
        let url = GLOBAL.URL+"/main/api/borrowing/applyBorrowing.json";
        let params = data;
        if(data.channel=="hxdapp"){
            return hxdRESTPluginPost(url,params);
        }
