...
export default {
    // 获取卡列表
    achieveCardList(data){
        let url = GLOBAL.URL+"/main/api/wealth/lcptBindCard/queryCardList.json";
        let params = data;
    ...
    // 添加借记卡
    addCard(data){
        let url = GLOBAL.URL+"/main/api/wealth/lcptBindCard/addDebitCard.json";
        let params = data;
        if(data.channel=="hxdapp"){
            return hxdRESTPluginPost(url,params);
        }
    ...
    // 查询银行
    searchBank(data){
        let url = GLOBAL.URL+"/main/api/wealth/lcptBindCard/getBankByCardBin.json";
        let params = data;
        if(data.channel=="hxdapp"){
            return hxdRESTPluginPost(url,params);
        }
