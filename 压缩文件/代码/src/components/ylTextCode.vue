...
<template lang="pug">
  .text-code-view
    span.yzm {{lab}}
    input.ipt(v-model="idNum" placeholder="请输入验证码" type="tel" @focus="toSetHeight" @input="getValue" @blur="achieveValue" maxlength="6")
    .err {{err}}
...
<script>
import {setHeight} from "@/assets/js/common.js";
  export default {
    name: "ylTextCode",
    props:['innerHeight','textMsg','label',"clickBl","type"],
    data() {
      return {
        idNum: '',
        lab:'',
...
<style scoped lang="stylus">
  .text-code-view
    ...
    background #fff
    padding 0.075rem 0 0.075rem 5.3%
