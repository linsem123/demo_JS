<template>
    <div id="smsCode" data-flag="flag_one">
		<div class="smstxt">
...
// import sa from "sa-sdk-javascript"; //听云监听
...
export default {
    ...
    methods:{
        bindEvents(){
            this.flag_one = this.pdata.identflag;
            ...
            arrow.addEventListener("touchend",(e)=>{
                if(isTouchStart){
                    ...
                    isTouchStart=true;
                    this.$store.dispatch('sendmovelen',{
                        sendlen:moveX,
                        hdata:this.hdata,
